...
$config = array(
    ...
    */
    ...
    |
    */
    'current_path' => isset($_ENV['FM_RELATIVE_FILE_PATH']) ? $_ENV['FM_RELATIVE_FILE_PATH'] : '../../../../../../../../public/uploads/files/',
    'preview_path' => isset($_ENV['FM_RELATIVE_PREVIEW_FILE_PATH']) ? $_ENV['FM_RELATIVE_PREVIEW_FILE_PATH'] : '../../../../../../../../public/uploads/files/',
    ...
    |
    */
    'thumbs_base_path' => isset($_ENV['FM_RELATIVE_THUMB_PATH']) ? $_ENV['FM_RELATIVE_THUMB_PATH'] : '../../../../../../../../public/thumbs/',
    ...
    */
    ...
    'ext_file'                                => array( 'doc', 'docx', 'rtf', 'pdf', 'xls', 'xlsx', 'txt', 'csv', 'html', 'xhtml', 'psd', 'sql', 'log', 'fla', 'xml', 'ade', 'adp', 'mdb', 'accdb', 'ppt', 'pptx', 'odt', 'ots', 'ott', 'odb', 'odg', 'otp', 'otg', 'odf', 'ods', 'odp', 'css', 'ai', 'kmz','dwg', 'dxf', 'hpgl', 'plt', 'spl', 'step', 'stp', 'iges', 'igs', 'sat', 'cgm', 'tiff', 'tif', 'eps', ''), //Files
